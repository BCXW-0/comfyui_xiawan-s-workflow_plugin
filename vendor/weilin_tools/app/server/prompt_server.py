...
# Xiawan only vendors the prompt editor. Tag-image generation is intentionally
# not started because it is unrelated to the workflow node and consumes a
# background task even when the editor is never opened.
