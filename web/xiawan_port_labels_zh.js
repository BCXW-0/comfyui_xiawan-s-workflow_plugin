...
const NODE_LABELS = Object.freeze({
  ...
  XiawanBaseImagePreview: { outputs: { any_output: "任意输出", image_pass: "图像直通", model_pass: "模型直通", freemem_before: "执行前显存(MB)", freemem_after: "执行后显存(MB)" } },
